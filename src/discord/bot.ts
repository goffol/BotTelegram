...
async function handleAddUid(message: Message, args: string[]) {
...
async function handleAddAkses(message: Message) {
  const userId = message.author.id;
...
async function handleListAkses(message: Message) {
...
async function handleFlow(message: Message) {
